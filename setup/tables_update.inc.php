 ...
 * @return string
 */
function webauthn_upgrade21_1()
{
	return $GLOBALS['setup_info']['webauthn']['currentver'] = '23.1';
}
 ...
 * @return string
 */
function webauthn_upgrade23_1()
{
	return $GLOBALS['setup_info']['webauthn']['currentver'] = '26.1';
}